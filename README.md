...
Если вы хотите поэкспериментировать с дизайном, логикой фокуса или аналитикой — проект структурирован так, чтобы любые изменения в одном модуле (например, `FocusViewModel` или `AnalyticsView`) были максимально изолированы и предсказуемы.
